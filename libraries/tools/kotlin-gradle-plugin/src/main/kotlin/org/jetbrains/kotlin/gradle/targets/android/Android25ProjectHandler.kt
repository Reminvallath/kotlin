...
class Android25ProjectHandler(
    ...
    override fun getJavaTask(variantData: BaseVariant): AbstractCompile {
        ...
        return variantData.getJavaTaskProvider()?.get() ?: variantData.javaCompile
    }
...
@Suppress("UNCHECKED_CAST")
internal fun BaseVariant.getJavaTaskProvider(): TaskProvider<out AbstractCompile>? =
    this::class.java.methods.firstOrNull { it.name == "getJavaCompileProvider" }
        ?.invoke(this) as? TaskProvider<AbstractCompile>
